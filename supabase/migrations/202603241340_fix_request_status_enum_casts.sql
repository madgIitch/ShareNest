-- ============================================================
-- ShareNest - Fix enum casts in request flow RPCs
-- 2026-03-24
-- ============================================================

-- Root cause:
-- requests.status is enum request_status in this environment.
-- Assigning a text variable (e.g. v_status_offered text := 'offered')
-- to enum columns raises:
